...
Overview receipts treat only a closed ```suggestion fence on a non-LEFT comment as applyable. See [`docs/doctoring/review-inline-comment-422-fallback.md`](docs/doctoring/review-inline-comment-422-fallback.md).
