...
Overview receipts treat only a closed ```suggestion fence on a non-LEFT comment as applyable. Leftover Manual-edit excerpts strip HTML comment delimiters and metacharacters. See [`docs/doctoring/review-inline-comment-422-fallback.md`](docs/doctoring/review-inline-comment-422-fallback.md).
