...
PyO3 peer deferral ignores prose under `docs/requirements/`. See [`docs/doctoring/python-native-extension-peer-evidence.md`](docs/doctoring/python-native-extension-peer-evidence.md).
