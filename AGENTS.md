...
Safe pytest discovery accepts `python3.N -m pytest`. See [`docs/doctoring/safe-pytest-first-module-target.md`](docs/doctoring/safe-pytest-first-module-target.md).
