...
The materialization contract is also covered by [`docs/doctoring/opencode-review-quality-evaluation.md`](docs/doctoring/opencode-review-quality-evaluation.md).
