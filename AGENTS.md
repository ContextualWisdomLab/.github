...
OpenCode APPROVE must name every current-head changed file as a whole path token. See [`docs/doctoring/review-contract-per-file-disposition.md`](docs/doctoring/review-contract-per-file-disposition.md).
