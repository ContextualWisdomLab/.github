...
Trusted-uv download retries HTTP 522 with the closed delay set. See [`docs/doctoring/trusted-uv-transient-download-retry.md`](docs/doctoring/trusted-uv-transient-download-retry.md).
