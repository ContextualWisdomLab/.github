...
naruon hourly NVIDIA NIM repair is a thin caller at minute 11. See [`docs/doctoring/naruon-hourly-review-caller.md`](docs/doctoring/naruon-hourly-review-caller.md).
