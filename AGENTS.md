...
newsdom-api hourly NVIDIA NIM repair is a thin caller at minute 18. See [`docs/doctoring/newsdom-api-hourly-review-caller.md`](docs/doctoring/newsdom-api-hourly-review-caller.md).
