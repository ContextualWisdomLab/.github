...
`finding_location_error` rejects line `0` and `True` before the EOF probe. See [`ARCHITECTURE.md`](ARCHITECTURE.md) and [`docs/doctoring/review-line-anchored-findings.md`](docs/doctoring/review-line-anchored-findings.md).
