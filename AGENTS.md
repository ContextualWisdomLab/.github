...
Trusted-uv installer accepts Linux `amd64` / `AMD64` / padded `x86_64` as the pinned archive ISA. See [`ARCHITECTURE.md`](ARCHITECTURE.md) and [`docs/doctoring/trusted-uv-lock-materialization.md`](docs/doctoring/trusted-uv-lock-materialization.md).
