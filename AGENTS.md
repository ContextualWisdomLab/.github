...
Strix leftover-TUI neutralization honors `incomplete-evidence` and `failed after provider infrastructure or failure-signal output`. See [`ARCHITECTURE.md`](ARCHITECTURE.md) and [`docs/doctoring/strix-incomplete-retry-severity.md`](docs/doctoring/strix-incomplete-retry-severity.md).
