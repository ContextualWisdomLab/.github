...
Downloaded Actions job logs keep per-line RFC 3339 runner timestamps; `redact_sensitive_log` skips them inside JSON spans and does not treat `[INFO]` as an array opener. See [`docs/doctoring/sandbox-log-redaction.md`](docs/doctoring/sandbox-log-redaction.md).
