...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" "opencode-free/mimo-v2.5-free omniroute/auto ' || ''" "opencode review adds the keyless OmniRoute gateway as an early public-only candidate"
