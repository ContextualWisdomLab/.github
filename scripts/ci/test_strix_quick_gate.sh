...
assert_pr_review_merge_scheduler_uses_github_actions_bot_token() {
	...
	assert_file_contains "$workflow_file" 'review_dispatch_limit="1"' "scheduler empty review_dispatch_limit falls back to one dispatch; explicit -1 remains unlimited"
