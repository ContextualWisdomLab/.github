...
assert_opencode_review_uses_codegraph_and_contextual_orchestrator() {
	...
	assert_file_contains "$workflow_file" 'OPENCODE_ZEN_API_KEY: ${{ secrets.OPENCODE_ZEN_API_KEY }}' "opencode review passes the optional OpenCode credential only to sidecar bootstrap"
	assert_file_contains "$workflow_file" 'EXPERIENTIAL_LABS_API_KEY: ${{ secrets.EXPERIENTIAL_LABS_API_KEY || secrets.EXPERIENTAL_LABS_API_KEY }}' "opencode review passes the canonical Experiential credential with a legacy fallback"
	assert_file_contains "$workflow_file" 'EXPERIENTAL_LABS_API_KEY: ${{ secrets.EXPERIENTIAL_LABS_API_KEY || secrets.EXPERIENTAL_LABS_API_KEY }}' "opencode review passes the legacy Experiential credential alias"
