...
assert_strix_workflow_pr_trigger_hardened() {
	...
	assert_file_not_contains "$workflow_file" "models: read" "strix workflow no longer grants GitHub Models read permission"
	...
	assert_file_not_contains "$workflow_file" "github_models/openai/o3" "strix workflow does not keep GitHub Models fallbacks"
	...
	assert_file_not_contains "$workflow_file" "Prepare GitHub Models fallback credentials" "strix workflow does not provision GitHub Models fallback credentials"
