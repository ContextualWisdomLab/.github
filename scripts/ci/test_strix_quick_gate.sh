...
assert_pr_review_merge_scheduler_uses_github_actions_bot_token() {
	...
	assert_file_contains "$workflow_file" 'workflows: ["Required OpenCode Review", "Strix Security Scan", "Security Scan", "SAST Semgrep"]' "scheduler reruns after review or security evidence completion so approvals can trigger merge/update actions"
