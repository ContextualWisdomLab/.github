...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" "metadata changed before OIDC" "opencode privileged review fails closed for workflow-dispatched fork or stale heads with a visible reason"
