...
assert_strix_workflow_pr_trigger_hardened() {
	...
	assert_file_contains "$workflow_file" 'export LLM_TIMEOUT=300' "strix keeps the Strix 1.5.3 parser bootstrap timeout positive"
