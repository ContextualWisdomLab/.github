...
assert_pr_review_merge_scheduler_uses_github_actions_bot_token() {
	...
	assert_file_contains "$workflow_file" 'default_review_dispatch_limit="1"' "event-path review dispatch defaults to 1"
	assert_file_contains "$workflow_file" 'default_review_dispatch_limit="8"' "schedule recovery review dispatch defaults to measured 8"
