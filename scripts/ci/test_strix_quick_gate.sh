...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" "## Adversarial validation" "opencode model-unavailable approval includes mandatory structured adversarial probes"
	assert_file_contains "$workflow_file" '"status":"passed","probes"' "opencode model-unavailable approval records machine-readable adversarial probes"
	assert_file_contains "$workflow_file" "mandatory structured adversarial probes" "opencode model-unavailable approval explains that clean fallback approval is probe-gated"
