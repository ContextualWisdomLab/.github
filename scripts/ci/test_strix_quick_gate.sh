...
assert_opencode_review_uses_codegraph_and_gpt5_fallback() {
	...
	assert_file_contains "$workflow_file" "no APPROVE review will be published without mandatory structured adversarial probes" "opencode general model-unavailable path fails closed without adversarial evidence"
