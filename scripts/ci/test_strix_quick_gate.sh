...
assert_file_contains "$REPO_ROOT/scripts/ci/run_opencode_review_model_pool.sh" 'OPENCODE_NVIDIA_NIM_TOTAL_BUDGET_SECONDS 7200' "opencode NVIDIA NIM combined runtime cap defaults to two hours"
	...
	assert_file_contains "$workflow_file" '"deepseek/deepseek-r1-0528"' "opencode isolated catalog still defines DeepSeek R1 0528"
	assert_file_contains "$workflow_file" '"deepseek/deepseek-r1"' "opencode isolated catalog still defines DeepSeek R1"
	...
	assert_file_not_contains "$workflow_file" "opencode/gpt-5.6-terra" "opencode review omits Copilot-class Zen Terra from the model pool"
	assert_file_contains "$workflow_file" '"deepseek/deepseek-r1-0528"' "opencode isolated catalog still defines DeepSeek R1 0528"
	assert_file_contains "$workflow_file" "github-models/deepseek/deepseek-v3-0324" "opencode publish-stage diagnosis may still name DeepSeek V3"
	...
	assert_file_contains "$workflow_file" '"openai/gpt-5"' "opencode isolated catalog still defines GitHub Models GPT-5"
	...
	assert_file_contains "$workflow_file" '"openai/gpt-5-chat"' "opencode isolated catalog still defines GitHub Models GPT-5 chat"
