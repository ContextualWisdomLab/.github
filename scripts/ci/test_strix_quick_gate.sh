...
assert_pr_review_merge_scheduler_uses_github_actions_bot_token() {
	...
	assert_file_contains "$workflow_file" "cancel-in-progress: false" "scheduler keeps required queue scans from leaving cancelled conclusions in the required-check rollup"
