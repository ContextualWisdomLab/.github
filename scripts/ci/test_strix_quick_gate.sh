...
assert_file_contains "$REPO_ROOT/scripts/ci/run_opencode_review_model_pool.sh" 'OPENCODE_NVIDIA_NIM_TOTAL_BUDGET_SECONDS 900' "opencode NVIDIA NIM combined runtime cap defaults to fifteen minutes"
	...
	assert_file_contains "$workflow_file" "opencode-free/north-mini-code-free" "opencode review retains a public free coding fallback"
	assert_file_contains "$workflow_file" "opencode/gpt-5.6-terra opencode-free/nemotron-3-ultra-free" "opencode review reaches paid Zen before hour-class free fallbacks"
	...
	assert_file_contains "$workflow_file" "opencode/gpt-5.6-terra opencode-free/nemotron-3-ultra-free" "opencode review tries paid Zen before hour-class free fallbacks"
