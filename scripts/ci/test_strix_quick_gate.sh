...
assert_strix_workflow_pr_trigger_hardened() {
	...
	assert_file_contains "$workflow_file" "cancel-in-progress: \${{ github.event_name == 'push' }}" "strix workflow cancels superseded push scans but preserves PR lifecycle evidence"
