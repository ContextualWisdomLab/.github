...
assert_pr_review_merge_scheduler_uses_github_actions_bot_token() {
	...
	assert_file_contains "$workflow_file" 'review_dispatch_limit="1"' "scheduler caps OpenCode/Strix review dispatches per run at 1 (empty/-1 coerce to 1; never unlimited)"
