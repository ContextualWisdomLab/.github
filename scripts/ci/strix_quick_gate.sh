...
VERSION
EOF
		# CI/workflow changes in a Rust workspace need manifests and policy context
		# so cargo-deny can analyze the project instead of reporting an incomplete scan.
