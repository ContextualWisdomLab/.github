...
# more than one independently credentialed account -- pool=="free" builds no
...
# a single-account remainder survives it. A caller that has already gated its
# own decision to request this sidecar on live credential-account evidence
