...
assert_file_contains "$workflow_file" 'repository: ContextualWisdomLab/.github' "Strix workflow checks out resolved central repository"
assert_file_contains "$workflow_file" 'ref: ${{ github.workflow_sha }}' "Strix workflow checks out resolved central workflow SHA"
