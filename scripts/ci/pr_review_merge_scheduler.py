...
def has_independent_current_head_approval(pr: dict[str, Any]) -> bool:
    ...
    for review in reversed((pr.get("reviews") or {}).get("nodes") or []):
        ...
        if reviewer and reviewer != author and not is_automated_opencode_review(review):
            return True
    return False
...
def inspect_pr(
    ...
    *,
    ...
    if approval_reason and auto_merge_enabled and str(pr.get("reviewDecision") or "").upper() == "APPROVED":
        return finish(
            disable_auto_merge_decision(
                repo,
                pr,
        ...
        "reviews": {
            "nodes": [
                ...
                },
                {
                    ...
                    "body": "Independent reviewer approved this head.",
    ...
    sample["reviews"]["nodes"].append(
        {
            ...
            "author": {"login": "independent-reviewer"},
            "body": "Independent reviewer approved this head.",
            "submittedAt": "2026-06-25T15:44:19Z",
            "commit": {"oid": "abc"},
        }
    )
