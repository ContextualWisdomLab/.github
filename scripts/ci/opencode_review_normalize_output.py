...
def valid_control(
    ...
    *,
    ...
    # 🛡️ Sentinel: Enforce strict length limits on reason and summary to prevent
    # Regular Expression Denial of Service (ReDoS) against our scanning patterns.
    if len(reason) > 5000:  # pragma: no cover
        return reject("reason exceeds maximum permitted length of 5000 characters")
    if len(summary) > 5000:  # pragma: no cover
        return reject("summary exceeds maximum permitted length of 5000 characters")
