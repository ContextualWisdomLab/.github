...
def runtime_tool_slug(tool_name: str) -> str:
    ...
    # ⚡ Bolt: Using native C-speed string methods for faster whitespace normalization instead of regex substitution
...
def runtime_assertion_is_negated(
    ...
    *,
    ...
    # ⚡ Bolt: Using pre-compiled module-level NEGATION_BOUNDARY_PATTERN to avoid inner loop regex compilation overhead
...
def claimed_runtime_tools(text: str) -> tuple[str, ...]:
    ...
    for tool_match in RUNTIME_TOOL_PATTERN.finditer(text):
        ...
        # ⚡ Bolt: Using pre-compiled module-level SENTENCE_BOUNDARY_PATTERN to avoid inner loop regex compilation overhead
