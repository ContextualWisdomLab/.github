...
# An ambiguous recovery settlement can add two extra history-list polls after
# the initial poll, and every one of the three polls can require a history-state
# GET when an intervening version is visible before the delayed restore appears.
