...
- Allowed commas and ASCII parentheses in the bounded Strix changed-file path policy so legal tracked Packrat fixtures can receive exact-head security analysis while traversal, controls, backslashes, whitespace ambiguity, and shell punctuation remain fail-closed.
