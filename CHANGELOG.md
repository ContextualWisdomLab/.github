...
## [Unreleased]
- Make the contextual-orchestrator bearer-file ownership and mode checks
  portable across GNU/Linux and macOS runners while preserving the same
  fail-closed regular-file, owner, mode-0600, size, and single-line contract.
