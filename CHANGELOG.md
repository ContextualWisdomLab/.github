...
- Redacted credential-shaped values from sandboxed verification command argv, web E2E command strings, and evidence notes before they are printed or serialized, while leaving operational paths and pytest selectors readable.
