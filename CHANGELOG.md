...
- Retry one transient incomplete pull-request identity response before failing
  queue-health collection with the repository context, while preserving exact-head
  fail-closed classification when the metadata remains incomplete.
