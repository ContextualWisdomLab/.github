...
- Added an hourly exact-default-branch production-stub inventory that assigns each repository to one stable twelfth, scans at most 12 repositories per invocation, and continues deferred work through deterministic windows.
