...
- Included Rust source files, Cargo manifests, lockfiles, toolchain, and `deny.toml` context when workflow or CI changes scope a Rust workspace, preventing Strix from misclassifying a complete dependency scan as incomplete.
