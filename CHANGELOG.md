...
- Pinned Strix CI `google-api-core==2.34.0` with both published SHA-256 digests and a contract that rejects a leftover 2.33.0 line so `--require-hashes` cannot install an unreviewed wheel (CWE-494, CWE-829).
