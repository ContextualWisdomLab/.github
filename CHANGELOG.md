...
- OpenCode APPROVE now fails closed when the reason/summary omits any current-head changed file. Naming one path is no longer a file-by-file walk; the trusted changed-file artifact remains the file set.
