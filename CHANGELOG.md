...
- Parallelized organization mention-sweep PR discovery with a five-worker bound, a serial fast path for one repository, deterministic repository order, and cancellation when the dispatch limit is reached.
