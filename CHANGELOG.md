...
- Classify Strix Caido guest-login and local `127.0.0.1:48080` startup failures as infrastructure unavailability when no vulnerability report exists, preserving fail-closed handling for genuine findings and making the warning identify the scanner-runtime boundary.
