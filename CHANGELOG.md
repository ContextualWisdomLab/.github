...
- Publish bounded, credential-redacted OpenCode coverage setup diagnostics through one shared helper, add a hash-locked Python 3.10 TOML compatibility dependency, and preserve exact-head validation.
