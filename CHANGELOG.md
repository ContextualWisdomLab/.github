...
- Corrected the exact-head coverage fetch retry log so the final propagation attempt reports that no retries remain instead of claiming another retry will occur.
