...
- Refresh the hash-pinned `pip` used by the Python security audit from 26.1.2 to
  26.2.1 so the audit no longer installs the vulnerable PYSEC-2026-3721 release.
