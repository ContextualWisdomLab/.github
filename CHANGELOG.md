...
- Retried CodeQL `init` after a GitHub feature-enablement API 503 (`No server is currently available`) so a partial GitHub outage does not fail the required compatibility analysis.
