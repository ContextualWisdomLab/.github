...
- Pinned Strix CI `types-requests==2.33.0.20260712` with both published SHA-256 digests and a contract that rejects a leftover 2.33.0.20260518 line so `--require-hashes` cannot install an unreviewed stub wheel (CWE-494, CWE-829).
