...
- Added the CWL repository responsibility catalogue with closed service/relationship schemas, a conservative 24-repository capability ledger, customer next actions, strict semantic validation, exact-head 100% statement/branch/docstring quality evidence, and CSAP/SOC 2 engineering-readiness documentation.
