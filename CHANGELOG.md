### Noema reviews preserve the counterexample behind each probe

- Published reviews now include the supplied attack scenario or counterexample
  alongside the hypothesis, evidence, and outcome, so readers can follow the
  reasoning. Verdicts and reviewed-commit bindings are unchanged.
