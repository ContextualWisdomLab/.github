...
1. Integrate PR #1013 normally and retain its event/command envelopes as the authority.
2. Integrate this catalogue from the resulting protected `main` without changing its semantic contracts.
3. Add one leaf capability manifest and provider/consumer pair at a time.
