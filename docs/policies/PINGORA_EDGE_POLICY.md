...
CRC-valid chunk stream ending at IEND with conforming chunk names and palette
bounds whose bounded null- or Adam7-interlaced decompressed scanlines match IHDR.
