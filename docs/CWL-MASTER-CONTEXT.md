...
- **Commercially acceptable license allowlist ONLY** — MIT/Apache-2.0/BSD/ISC/MPL-2.0/PostgreSQL. MPL-2.0 is the sole explicitly accepted weak-copyleft license; NO GPL/AGPL/strong copyleft/non-commercial. Verify via `gh api repos/<o>/<r> --jq .license.spdx_id` before adding. (ZITADEL=AGPL removed; MinerU=Apache OK; ParadeDB pg_search=AGPL avoid; ClamAV=GPL avoid.)
