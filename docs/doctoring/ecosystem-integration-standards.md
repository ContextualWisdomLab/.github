...
- **AsyncAPI 3.0.0** is the baseline for repositories that publish asynchronous channel contracts.
...
- **W3C Trace Context** defines stable cross-service tracing headers. The 2021 Recommendation is used as the production baseline rather than making a draft-level successor a hard dependency.
...
AsyncAPI Initiative. (n.d.). *AsyncAPI specification (Version 3.0.0).* Retrieved August 15, 2026, from https://www.asyncapi.com/docs/reference/specification/v3.0.0
