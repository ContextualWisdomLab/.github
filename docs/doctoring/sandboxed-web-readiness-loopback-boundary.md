...
`127.0.0.0/8`, an unspecified address, a public hostname, and the common cloud
metadata address. The existing no-redirect test continues to prove that an
allowed readiness endpoint cannot redirect the poller across the boundary.
