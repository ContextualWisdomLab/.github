...
- RED: commit `be8702379171e7aa2f53d887326c524c20ee26a6` records two POST attempts only after the primary is
  made to return HTTP 403; the predecessor emitted one failed POST.
- GREEN: commit `376230157ea9303267defe28bf519d69c5875ae2` tries the bounded credential chain and succeeds on
