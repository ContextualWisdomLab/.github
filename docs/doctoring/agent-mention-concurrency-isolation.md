...
Replacement PR #824 starts from exact prerequisite #823 head `9dfb5ee2795b845f709f5f85ba68c8dda5810f43`. Exact RED head `e8ee2debfd3ec6aada677e0d8f14b4c79fc2d5b6` changed only `tests/test_agent_mention_workflow_contract.py` and required separate job-scoped queue contracts while the inherited workflow still had one shared workflow-level group.

This replacement does not reuse predecessor PR #815 checks, reviews, approvals, or mergeability evidence.
