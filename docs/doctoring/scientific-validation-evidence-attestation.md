...
- #2305 source-level RED `e56ab5735be195ce7b9016b7a69713521621170d` swaps a validated output parent pathname immediately after both destinations are accepted and requires publication to stay bound to the original parent inode. Causal repair `d0e00074ef2a3ab52ba1bf2069143baec9116f3b` pins output parent descriptors and publishes through descriptor-relative temporary creation/replacement; `d755e8f9565a348e1a836f70b647b93d2551e98d` covers descriptor-relative cleanup and `076fff5ec28481f350517e1d7b9ffa3b8c8ffc9d` removes the path-based compatibility writer in favor of the same pinned publication primitive.
