...
The newest cohort has explicit source ownership: `PolicyWeave#1` carries its exact-cased badge and `docs/index.md`; `supply-chain-control-plane#1` now carries its exact badge and bounded Pages landing source on the active product writer; `learning-management-platform#1` already owns both the product-first README badge and `docs/index.md`; and `learning-content-studio#1` owns the badge while stacked `learning-content-studio#8` owns only `docs/index.md`. Their live repositories still report Pages disabled until protected integration and trusted reconciliation complete.
...
The explicit label assignments now cover 41 evidence-backed targets: `.github#1582`, `.github#1622`, `.github#1625`, `.github#1634`, `CalendarWeave#1`, `ConceptWeave#1`, `context-graph-contracts#20`, `RankWeave#40`, `fast-mlsirm#1717`, `EgressWeave#231`, `psychometrics-commons#442`, `contextual-orchestrator#994`, `contextual-orchestrator#1003`, `appguardrail#1077`, `naruon#1513`, `LineageWeave#908`, `ContextualWisdomLab.github.io#203`, `TEPP#435`, `semantic-data-portal#72`, `Orgmetra#160`, `learning-interoperability-contracts#1`, `noema#530`, `bandscope#1125`, `saju-caldav#44`, `OriginWeave#274`, `semantic-data-portal#90`, `accounting-information-platform#45`, `clearfolio#538`, `pg-erd-cloud#1046`, `DiagramWeave#34`, `keyverse#127`, `mhtml-etl-gateway#56`, `j-planner#2`, `learning-record-store#1`, `learning-record-store#7`, `learning-content-studio#1`, `learning-content-studio#8`, `learning-management-platform#1`, `metering-billing-platform#175`, `PolicyWeave#1`, and `supply-chain-control-plane#1`. The assignment reconciler preserves richer repository-local labels such as priority, status, and `type: maintenance` when those labels are outside the managed semantic set.
