...
- [`PR_GOVERNANCE_AUDIT.md`](PR_GOVERNANCE_AUDIT.md) — live review/merge
  contract.
- [`docs/doctoring/sandbox-command-metadata-secret-redaction.md`](docs/doctoring/sandbox-command-metadata-secret-redaction.md)
  — current increment's secret-redaction decision and APA 7th citations.
