...
def test_lineageweave_caller_is_hourly_bounded_and_non_cancelling() -> None:
    """LineageWeave receives one realistic repair without cancellation."""
    caller = _read(CALLER)
...
def test_lineageweave_doctoring_records_activation_and_credentials() -> None:
    """Operators retain target-allowlist, RCA, and approval prerequisites."""
    ...
    for phrase in (
        ...
        "APA 7th references",
        "ContextualWisdomLab/LineageWeave#494",
        "ContextualWisdomLab/LineageWeave#426",
        "ContextualWisdomLab/LineageWeave#429",
        "ContextualWisdomLab/LineageWeave#355",
    ):
