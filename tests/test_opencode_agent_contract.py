...
def test_workflow_provisions_sandbox_tool_and_reviewer_agent():
    ...
    assert re.search(r"Run OpenCode PR Review model pool[\s\S]{0,260}timeout-minutes: 150", workflow)
    ...
    assert 'OPENCODE_TOTAL_RETRY_BUDGET_SECONDS: "8400"' in workflow
