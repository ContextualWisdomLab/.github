...
def _ruleset_payload() -> dict:
    """Build an independent ten-workflow live-policy oracle."""
    return {
        "id": audit.RULESET_ID,
...
def test_production_inventory_matches_independent_ten_path_oracle() -> None:
...
def test_independent_ten_path_payload_passes() -> None:
...
def test_unexpected_live_workflow_fails_closed() -> None:
    ...
    assert errors == [
        "unexpected central required workflow .github/workflows/unreviewed-extra.yml"
    ]
