...
def test_timeout_output_text_normalizes_subprocess_payloads():
    ...
    assert sandboxed_verify.timeout_output_text(f"my ghp_{'1'*36} token") == "my [REDACTED] token"
    assert sandboxed_verify.timeout_output_text(b"my ghp_" + b"1" * 36 + b" token") == "my [REDACTED] token"
