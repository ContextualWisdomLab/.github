...
def test_appguardrail_caller_is_hourly_bounded_and_non_cancelling() -> None:
    """Appguardrail receives one realistic SAST repair without cancellation."""
    caller = _read(CALLER)
...
def test_appguardrail_doctoring_records_sast_activation_and_credentials() -> None:
    """Operators retain target-allowlist, SAST, and approval prerequisites."""
    ...
    for phrase in (
        ...
        "APA 7th references",
        "ContextualWisdomLab/appguardrail#964",
        "ContextualWisdomLab/appguardrail#967",
        "ContextualWisdomLab/appguardrail#970",
        "ContextualWisdomLab/appguardrail#971",
    ):
