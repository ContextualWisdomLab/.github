            ...
            "probes": [
                {
                    ...
                    "class_evidence": {'raw_value': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'conversion_path': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'canonicality_guard': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}},
                ...
                },
                {
                    ...
                    "class_evidence": {'assertion_under_test': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'negative_control': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'distinguishing_observation': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}},
...
"""
    valid = {
        ...
        "adversarial_validation": {
            ...
            "residual_risk": "Callers were not executed.",
            "probes": [
                {"path": "tool.py", "line": 1, "side": "RIGHT", "probe_kind": "coercion_boundary", "class_evidence": {'raw_value': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'conversion_path': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'canonicality_guard': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}}, "hypothesis": "A non-boolean value crosses the canonical boundary.", "attack_or_counterexample": "Compare with a truthy string negative control.", "evidence": "The literal is the canonical boolean True.", "outcome": "falsified"},
                {"path": "tool.py", "line": 1, "side": "RIGHT", "probe_kind": "test_oracle", "class_evidence": {'assertion_under_test': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'negative_control': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}, 'distinguishing_observation': {'path': 'tool.py', 'line': 1, 'side': 'RIGHT'}}, "hypothesis": "A presence-only oracle accepts a wrong replacement.", "attack_or_counterexample": "Use a present but non-boolean assignment.", "evidence": "The changed assignment has the exact expected boolean value.", "outcome": "falsified"},
            ],
        },
    }
            ...
            "probes": [
                {
                    ...
                    "class_evidence": {'first_contract': {'path': 'docs/old.md', 'line': 3, 'side': 'LEFT'}, 'second_contract': {'path': 'docs/old.md', 'line': 3, 'side': 'LEFT'}, 'contradiction_or_alignment': {'path': 'docs/old.md', 'line': 3, 'side': 'LEFT'}},
            ...
            "probes": [
                {
                    ...
                    "class_evidence": {'component_authority': {'path': 'config.yml', 'line': 1, 'side': 'RIGHT'}, 'external_authority': {'path': 'config.yml', 'line': 1, 'side': 'RIGHT'}, 'enforcement_boundary': {'path': 'config.yml', 'line': 1, 'side': 'RIGHT'}},
                ...
                },
                {
                    ...
                    "side": "RIGHT",
                    "probe_kind": "cross_contract",
                    "class_evidence": {'first_contract': {'path': 'config.yml', 'line': 1, 'side': 'RIGHT'}, 'second_contract': {'path': 'config.yml', 'line': 1, 'side': 'RIGHT'}, 'contradiction_or_alignment': {'path': 'config.yml', 'line': 1, 'side': 'RIGHT'}},
