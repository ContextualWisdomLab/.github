...
REVIEW_DISPATCH_BLOB_SHA = "3c512707483d17b4483e18864fa917093f8bee59"
...
def test_independent_review_agent_key_system_has_expected_exact_blob() -> None:
    """Pin the independent read-only reviewer workflow byte-for-byte."""
